...
<body class="bg-neutral-200 dark:bg-neutral-200 w-full z-20 top-0 start-0 ">
  <!-- Navbar start-->
...
<div data-popover id="popover-click" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-neutral-200">
  ...
  <div class="bg-[#63B3A8]  flex items-center justify-center gap-4 mt-16 min-h-full w-full p-20">
    <div class="bg-[#ffffff] bg-opacity-30 border border-neutral-20 px-8 w-1/2 mt-10 py-8 rounded-2xl">


      <h1 class="text-gray-700 ">get in touch</h1>

      <div class="mb-6">
        <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
        <input type="text" id="default-input"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-200 dark:border-neutral-200 dark:placeholder-neutral-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
      </div>
      <div class="mb-6">
      ...
      <textarea id="message" rows="4"
        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-200 dark:border-neutral-200 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
      <img src="assets/Container80.svg" alt="">
      <img src="assets/Group.svg" alt="">
    </div>

    <div>
      <img src="assets/gambar.png" width="500px" height="w-auto" class="ml-20 mt-8" alt="">
    </div>
  </div>

  <div>
    <h1
      class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black mt-12 text-center w-full">
      kontak kami everytime</h1>
    <div class="bg-neutral-200 w-full">
      <div
        class="max-w-md text-gray-900  divide-gray-200 dark:text-white  bg-neutral-200 flex flex-row justify-center w-full mx-auto gap-x-9">
        <div class="flex flex-col pb-3">
          <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-900">Email address</p>
          <p class="text-lg font-semibold text-gray-500">yourname@flowbite.com</p>
        </div>
        <div class="flex flex-col pb-3">
          <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-900">Email address</p>
          <p class="text-lg font-semibold text-gray-500">yourname@flowbite.com</p>
...
</html><?php /**PATH C:\VS code\Syariahrooms-main\resources\views/kontak.blade.php ENDPATH**/ ?>