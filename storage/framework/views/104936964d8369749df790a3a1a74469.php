...
<?php $__env->startSection('title', 'Transaksi | syariahrooms'); ?>
                ...
                <div class="col">
                    <div class="row justify-content-between my-10 gap-10 px-0">
                        <div class="row mx-md-0 col-auto mx-auto gap-10">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('transaction-store')): ?>
                ...
                <div class="modal-content">
                    <form id="formTransaksi">
                        ...
                        <div class="modal-footer">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('transaction-update')): ?>
                                <button class="btn btn-primary btn-edit-transaksi" type="submit"><i
                                        class="icofont icofont-pencil"></i> Edit</button>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('transaction-destroy')): ?>
...
<script>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['transaction-store', 'transaction-update'])): ?>
    ...
    function loadTransaksi(page, search) {
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(route('dashboard.transaction.data')); ?>",
            data: {
                'search': search,
                'page': page,
            },
    ...
    $('body').on('click', '.detail-transaksi', function() {
        var id = $(this).data('id');
        $.get("<?php echo e(route('dashboard.transaction.show', ':id')); ?>".replace(':id', id), function(data) {
    ...
    $('#formTransaksi').on('submit', function(e) {
        ...
        $.ajax({
            data: formData,
            url: "<?php echo e(route('dashboard.transaction.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('.btn-lepas-membership').on('click', function() {
        ...
        var url = "<?php echo e(route('dashboard.transaction.nonActiveMembership', ['id' => ':id'])); ?>";
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('dashboard.transaction.destroy', ':id')); ?>".replace(':id',
                            id),
                        success: function(data) {
                            $('#modalTransaksi').modal('hide');
                            swal("Success...", data.message, "success");
...
<?php echo $__env->make('master.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Syariahroom\resources\views/master/dashboard/transaksi/detail-transaksi/index.blade.php ENDPATH**/ ?>