...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Auth | Bank Syariah Indonesia - UAE'); ?></title>
</head>
        ...
        <div class="col-12 col-lg-6 bg-primary-4 hp-bg-color-dark-90 position-relative auth-image">
            <div class="row hp-image-row h-100 px-8 px-sm-16 px-md-0 pb-32 pb-sm-0 pt-32 pt-md-0">
                <div class="col-12 hp-logo-item m-16 m-sm-32 m-md-64 w-auto px-0">
                    <img class="hp-dark-none" src="../../../app-assets/img/logo/logo2auth.svg" alt="Logo">
                    <img class="hp-dark-block" src="../../../app-assets/img/logo/logo2auth.svg" alt="Logo">
                </div>
...
<?php /**PATH C:\xampp\htdocs\Syariahroom\resources\views/master/layouts/auth.blade.php ENDPATH**/ ?>