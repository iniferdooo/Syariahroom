...
<body class="bg-white dark:bg-neutral-200 fixed w-full z-20 top-0 start-0 h-auto">
  <!-- Navbar start-->
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul
          ...
          <li>
            <a href='/'
              class="block py-2 px-3 text-gray-900 rounded hover:bg-teal-500 md:hover:bg-transparent md:hover:text-teal-500 md:p-0 md:dark:hover:text-teal-500 dark:text-black dark:hover:bg-[#63B3A8] dark:hover:text-white md:dark:hover:bg-transparent dark:border-[#63B3A8]">Home</a>
          </li>
          <li>
            <a href='/fitur'
          ...
          <li>
            <a href='/membership'
              class="block py-2 px-3 text-gray-900 rounded hover:bg-teal-500 md:hover:bg-transparent md:hover:text-teal-500 md:p-0 md:dark:hover:text-[#63B3A8] dark:text-black dark:hover:bg-[#63B3A8] dark:hover:text-black md:dark:hover:bg-transparent dark:border-[#63B3A8]">Membership</a>
          </li>
          <li>
            <a href='/kontak'
              class="block py-2 px-3 text-gray-900 rounded hover:bg-teal-500 md:hover:bg-transparent md:hover:text-teal-500 md:p-0 md:dark:hover:text-[#63B3A8] dark:text-black dark:hover:bg-teal-500 dark:hover:text-[#63B3A8] md:dark:hover:bg-transparent dark:border-gray-700">Contact
              us</a>
          </li>
        </ul>
      </div>
...
<div data-popover id="popover-click" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-neutral-200">
  ...
  <div class=" w-full"><img
      src="https://images-wixmp-530a50041672c69d335ba4cf.wixmp.com/templates/image/7ece4e650c7e864408880fe10c47a3724dd7534c5812a3268fa0300b37d53f6b1680175310931.jpg"
...
</html><?php /**PATH C:\VS code\Syariahrooms-main\resources\views/fitur.blade.php ENDPATH**/ ?>