...
<head>
    ...
    <title>@yield('title', 'syariahrooms')</title>
</head>
            ...
            <div class="hp-sidebar-container">
                <div class="hp-sidebar-header-menu">
                    <div class="row justify-content-between align-items-end me-12 ms-24 mt-24">
                        ...
                        @include('master.partials.dashboard.logo')
                    ...
                    @include('master.partials.dashboard.sidebar')
                </div>
            </div>
        </div>

        <div class="hp-main-layout">
            @include('master.partials.dashboard.navbar')
            ...
            @include('master.partials.dashboard.footer')
        </div>
    </main>

    @include('master.partials.dashboard.custom-theme')

    @include('master.partials.logout')
